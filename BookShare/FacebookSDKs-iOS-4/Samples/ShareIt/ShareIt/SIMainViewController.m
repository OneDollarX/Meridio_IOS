...
- (void)viewDidLoad
{
  ...
  self.loginButton.publishPermissions = @[@"publish_actions"];
    photo = [SIPhoto photoWithObjectURL:[NSURL URLWithString:@"https://books.google.com/books/content?id=gfg13CM_kU8C&pg=PP1&img=1&zoom=5&sig=LsTwGVAsy_qWYMPM6HVDTPAMokg"]
                                  title:@"Make a Goofy Face"
                                 rating:5
                                  image:[UIImage imageNamed:@"Goofy"]];
